function edit_user(event){
    ...
    let email = document.getElementById("new_email1").value;
    let age = document.getElementById("new_age1").value;


    let xhttp = new XMLHttpRequest();
    xhttp.open("post", "../controller/edit_user_check.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send("old_name=" + old_name + "&new_username=" + name + "&new_password=" + password + "&new_email=" + email +"&new_age=" + age);
